...
function Stat() {
  ...
  <div className="p-4 text-center [box-shadow:0_2px_10px_-3px_rgba(6,81,237,0.3)] h-[200px]">
  ...
  <div className=" p-4  text-center  [box-shadow:0_2px_10px_-3px_rgba(6,81,234,20.3)]  h-[200px] ">
