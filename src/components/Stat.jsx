...
function Stat() {
  return (
   <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-2 md:gap-4 lg:gap-6 xl:gap-8 p-5 text-black mt-[50px]  md:mt-0  ">
  ...
  <div className="p-4 text-center bg-green-100 [box-shadow:0_2px_10px_-3px_rgba(6,81,237,0.3)] h-[200px]">
    ...
    <h1 className='text-6xl p-4 m'>79</h1>
